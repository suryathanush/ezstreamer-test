<nav x-data="{ open: false }" class="bg-indigo-50 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('streams_edit') }}" :active="request()->routeIs('streams_edit')">
                        {{ __('My Streams') }}
                    </x-jet-nav-link>
                </div>
              </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <x-jet-responsive-nav-link href="{{ route('streams_edit') }}" :active="request()->routeIs('streams_edit')">
                {{ __('My Streams') }}
            </x-jet-responsive-nav-link>
                <!-- Account Management -->
