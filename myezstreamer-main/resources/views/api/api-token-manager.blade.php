<div>
  <div class="mt-6">
    <div class="rounded-lg bg-indigo-50 max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">

    <!-- Generate API Token -->
    <x-jet-form-section submit="createApiToken">
        <x-slot name="title" class="text-slate-50">
            {{ __('Create API Token') }}
        </x-slot>

        <x-slot name="description">
            {{ __('API tokens allow third-party services to authenticate with your EZ Streamer.') }}
        </x-slot>
